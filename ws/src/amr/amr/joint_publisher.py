...
class SimplePublisher(Node):
    ...
    def __init__(self):
        super().__init__('joint_publisher')  # Initialize the node with the name 'simple_publisher'
        ...
        timer_period = 0.5  # Setting the timer period to .5 seconds
    ...
    def timer_callback(self):
        ...
        msg.data = [float(random.randrange(-90, 90)) for i in range(3)]  # Setting the message data
